...
answer_5 = {
    "Project": "MIDDLE",
    "Subject": "Function middle returns wrong value",
    "Description": """
    Function middle returns wrong value for a certain input (2,1,3). Expected input is 2, but function returns 1.
    
    Steps to reproduce:
    1. Execute the middle function with the following parameters: 2,1,3
    2. Compare the achieved result with 2, expected result.
    
    Alternatively:
    1. Run test test_213 from file test_middle.py
    
""",
    "Status": "new",
    "Priority": "**important**",
    "Assignee": "Marius Smytzek",
    "Start date": datetime.datetime(2023, 2, 25),
...
answer_6 = [
    ((r'pysnooper\tracer.py',), 109), 
    ((r'tests\pysnooper.py',), 82), 
    ((r'README.md',), 56),
    ((r'pysnooper\__init__.py',), 50)   
]
